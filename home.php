    ...
    <div class="post">
        ...
        <main>
            ...
            <div class="carte-projet">
                <a href="projet-site-deesse.html"><img class="img_projet" src="img/carte_projet.png" alt="Site Déesse"></a>
                <a href="projet-excel-deesse.html"><img class="img_projet" src="img/carte_projet_excel_deesse.png" alt="Application Déesse"></a>
            </div>
            <div class="carte-projet">
                <a href="projet-site-vlbfinances.html"><img class="img_projet" src="img/carte_projet_vlb.png" alt="Site VLB Finances"></a>
                <a href="projet-site-boucherie-argana.html"><img class="img_projet" src="img/carte_projet_boucherie.png" alt="Site Boucherie Argana"></a>
            </div>
            </div>
